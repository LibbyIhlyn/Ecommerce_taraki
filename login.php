...
<body>
      ...
      <div class="bg-img" style="background-image: url('./img/giphy.gif');">
        ...
        <nav id="nav" class="navbar nav-transparent">
            <div class="container">
                ...
                <a href="register.php"><button class="main-btn float-right">Register</button></a>                
                <!-- /Login and Register Buttons -->
    ...
    <!--Login Form-->
    <div id="login" class="section sm-padding">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
              <form method="POST" action="verify.php" class="contact-form"> <br/> <br/>
                <input type="email" class="input" id="email" placeholder="Email Address" name="username"> <br/> <br/>
                <input type="password" class="input" name="pwd" placeholder="Password" maxlength="10" minlength="5"> <br/> <br/> <br/>
