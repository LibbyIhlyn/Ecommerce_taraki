        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="section-header text-center">
                    ...
                    <a href="addproduct.php"><button class="btn btn-warning float-right">Add Product</button></a>
                </div>
                <br/>
                <!-- /Section header -->
        ...
        <?php
          ...
          if($result) {
            while($obj = $result->fetch_object()) {
              ...
              echo '<div class="col-md-4 section col-xs-6 work">';
              echo '<a href="editproduct.php?id='.$obj->id.'"><button class="btn-success float-right">Edit</button></a>';
              echo '<a onclick="return confirm(\'Are you sure you want to do delete this product?\')" href="deleteproduct.php?id='.$obj->id.'"> <button class="btn-danger float-right">Delete</button></a>';
