...
unset($_SESSION['cart']);
echo "<script type='text/javascript'>alert('Thank you for purchasing from Taraki Technologies! Your items will be delivered shortly, kindly wait for our message/call for the delivery.')</script>";
